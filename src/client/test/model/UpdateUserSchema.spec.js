...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WouldYouRatherBackend.UpdateUserSchema();
  });
  ...
  describe('UpdateUserSchema', function() {
    it('should create an instance of UpdateUserSchema', function() {
      // uncomment below and update the code to test UpdateUserSchema
      //var instance = new WouldYouRatherBackend.UpdateUserSchema();
      //expect(instance).to.be.a(WouldYouRatherBackend.UpdateUserSchema);
    });
