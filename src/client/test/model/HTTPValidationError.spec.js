...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WouldYouRatherBackend.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new WouldYouRatherBackend.HTTPValidationError();
      //expect(instance).to.be.a(WouldYouRatherBackend.HTTPValidationError);
    });
